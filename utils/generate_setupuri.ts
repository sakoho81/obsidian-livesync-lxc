// Bundled from: https://github.com/vrtmrz/obsidian-livesync/blob/main/utils/flyio/generate_setupuri.ts
// Generates obsidian://setuplivesync URIs for the Self-hosted LiveSync plugin.
